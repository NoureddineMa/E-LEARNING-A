...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE pstudents set id='" . $_POST['id'] . "', image='" . $_POST['image'] . "', name='" . $_POST['name'] . "', email='" . $_POST['email'] . "' ,phone='" . $_POST['phone'] . "'enroll_number='" . $_POST['userid'] . "'" . "date_of_addmision=" .$POST['date_of_addmision']);
